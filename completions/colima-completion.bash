...
__colima_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly colima allows to handle aliases
    args=("${words[@]:1}")
...
_colima_start()
{
    ...
    flags+=("--kubernetes-disable=")
    two_word_flags+=("--kubernetes-disable")
    local_nonpersistent_flags+=("--kubernetes-disable")
    local_nonpersistent_flags+=("--kubernetes-disable=")
    ...
    flags+=("--network-driver=")
    two_word_flags+=("--network-driver")
    local_nonpersistent_flags+=("--network-driver")
    local_nonpersistent_flags+=("--network-driver=")
    flags+=("--runtime=")
